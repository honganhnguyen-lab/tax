...
export const Route = createFileRoute("/returns/$id/review")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Trace every number on the return back to its source document, page, and box.",
      },
      { property: "og:title", content: "Ledgerline" },
      {
        property: "og:description",
        content:
          "Side-by-side return review with document highlights and AI extraction transparency.",
      },
    ],
  }),
  component: Review,
        ...
        <div className="p-4 sm:p-6 space-y-6">
          <header>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Click any line to see exactly where the number came from.
            </p>
          </header>
                      ...
                      <div className="flex items-center justify-between gap-3">
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-2 text-xs text-muted-foreground">
                            ...
                            {f.confidence != null &&
                              (f.state === "ai" || f.state === "needs_review") && (
      ...
      <div className="bg-muted/30 overflow-y-auto">
        {selected && source && doc && insight ? (
          ...
          <div className="p-8 text-sm text-muted-foreground">
            Select a line on the return to see its source.
          </div>
        )}
      </div>
    </div>
